...
public class InputDati {
	...
	private final static String ERRORE_FORMATO = "Errore : il formato del dato non è corretto";
	private final static String ERRORE_MINIMO = "Errore: il valore deve essere maggiore di ";
	private final static String ERRORE_STRINGA_VUOTA = "Errore: non hai inserito nessun carattere";
	private final static String ERRORE_MASSIMO = "Errore: il valore deve essere minore di ";
	private final static String MESSAGGIO_AMMISSIBILI = "Attenzione: i caratteri permessi sono: ";
